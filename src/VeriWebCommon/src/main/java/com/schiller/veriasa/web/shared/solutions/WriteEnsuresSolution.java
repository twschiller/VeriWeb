...
public class WriteEnsuresSolution extends MethodSolution implements HasImpossibleInfo{
	...
	private WriteEnsuresSolution(){
		
	}

	public WriteEnsuresSolution(List<Clause> statements, List<Clause> approvedObjectInvariants) {
		super();
	...
	public WriteEnsuresSolution(List<Clause> statements, List<Clause> approvedObjectInvariants, ImpossibleInfo info) {
