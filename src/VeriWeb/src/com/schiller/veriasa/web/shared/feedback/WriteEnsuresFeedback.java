...
public class WriteEnsuresFeedback extends Feedback implements Serializable, HasDynamicFeedback{
	...
	private WriteEnsuresFeedback(){
		
	}

	/**
	 * @param statement the ensures contract that the feedback corresponds to
	 ...
	 * to be an object invariant
	 */
	public WriteEnsuresFeedback(Clause statement, DynamicFeedback dynamicFeedback, boolean promptAsObjectInvariant) {
		super();
